...
class CreateAccountWebFailure final :
 ...
 public:
  ...
  private:
  ::authentication::CreateAccountWebFailure_Reason _internal_reason() const;
  void _internal_set_reason(::authentication::CreateAccountWebFailure_Reason value);
  public:
...
class AuthenticateWebFailure final :
 ...
 public:
  ...
  private:
  ::authentication::AuthenticateWebFailure_Reason _internal_reason() const;
  void _internal_set_reason(::authentication::AuthenticateWebFailure_Reason value);
  public:
...
inline ::authentication::CreateAccountWebFailure_Reason CreateAccountWebFailure::reason() const {
  // @@protoc_insertion_point(field_get:authentication.CreateAccountWebFailure.reason)
...
inline void CreateAccountWebFailure::set_reason(::authentication::CreateAccountWebFailure_Reason value) {
  ...
  // @@protoc_insertion_point(field_set:authentication.CreateAccountWebFailure.reason)
}
...
inline ::authentication::AuthenticateWebFailure_Reason AuthenticateWebFailure::reason() const {
  // @@protoc_insertion_point(field_get:authentication.AuthenticateWebFailure.reason)
  return _internal_reason();
}
...
inline void AuthenticateWebFailure::set_reason(::authentication::AuthenticateWebFailure_Reason value) {
  _internal_set_reason(value);
  // @@protoc_insertion_point(field_set:authentication.AuthenticateWebFailure.reason)
}
